...
fn main() {
    ...
    if config.approach == "sequence" {
        ...
        let client_to_target_idx_map: HashMap<u32, Vec<usize>> =
            sample::gen_client_to_target_idx_map(
                &client_to_seq_map,
                &mut rng,
        ...
        let mut client_to_sample_idx_map: HashMap<u32, Vec<usize>> =
            sample::gen_client_to_sample_idx_map(
                &client_to_seq_map,
                &mut rng,
        ...
        let client_to_test_idx_map: HashMap<u32, usize> =
            sample::gen_client_to_test_idx_map(&client_to_sample_idx_map, &mut rng);
